...
public final class JsonResourceReader implements ContentResourceReader {
    ...
    private static Logger logger = LoggerFactory.getLogger(JsonResourceReader.class);
...
//        return MessageContent.content().withContent(toJson(pojo)).build();
        ...
        MessageContent content = MessageContent.content().withContent(toJson(pojo)).build();
